...
function Home() {
  return (
    <div className='bg-gray-900 min-h-lvh'>
        <div className='flex md:justify-center p-5 hover:cursor-default'>
        ...
        <div className='flex px-5 md:justify-center md:p-1 hover:cursor-default'>
            {/* <div className='text-5xl md:text-7xl text-slate-200 font-extrabold'>Accelerate your career</div> */}
        ...
        {/* new box*/}
        <div className='m-8 flex flex-col rounded-2xl shadow-lg p-2 mt-10 md:ml-6 md:mr-6 md:flex-row bg-white hover:cursor-default'>
          ...
          <div className='flex flex-col gap-1 p-2 md:p-6'>
            ...
            <span className='font-bold text-gray-800'> 80 </span>
             ...
             <span className='font-semibold text-cyan-400'>Compiler </span>
        ...
        <div className='flex text-4xl font-bold justify-center text-slate-100 hover:cursor-default'>
            Available languages
        </div>
        <div className='m-8 border rounded-2xl gap-5 shadow-lg bg-cyan-950 hover:cursor-default'>
            {/* part one of lang 6 */}
