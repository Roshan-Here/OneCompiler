...
function NotFound() {
  return (
    <div className="h-screen w-screen bg-gray-50 flex items-center">
        <div className="container flex flex-col md:flex-row items-center justify-between px-6 text-gray-700">
                <div className="w-full lg:w-1/2 mx-8">
                    <div className="m-8 text-7xl text-green-500 font-dark font-extrabold mb-8"> 404</div>
